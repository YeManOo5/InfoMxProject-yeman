...
const exportTable = require('../models/exportbyproject');
...
exports.exportAllTable = fnErr(async(req, res, next) => {
    ...
    return res.status(200).json({
        status: 200,
         data: {getANCTable, getDeliTable, getPNCTable, getFPTable, getRHTable,getRegTable,getORegTable,  getGMTable,getOPDMedTable ,getOPDSurTable, getIPDTable,getCFRMTable, getLabTable,getIMAMTable, getIMAMSFPTable}
      });
})