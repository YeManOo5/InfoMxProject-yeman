...
//1 Total Number of services for Hypertension
exports.icdReport1 = async (a) => {
    try {
        ...
        from (select * from view_rptgm13icd where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 )tbl2 ) tbl3`
...
//2 Total Number of services for DM
exports.icdReport2 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday  
        from (select * from view_rptgm16icd  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 )tbl2 ) tbl3`
...
//3 Total Number of services for Malaria
exports.icdReport3 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from (select * from view_rptgm153  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 )tbl2 ) tbl3`
...
//4 Total Number of services for Diarrhoea
exports.icdReport4 = async (a) => {
    try {
        ...
        from (  select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from (select * from view_rptgm76   where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}   )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//5 Total Number of services for Other Respiratory Disease
exports.icdReport5 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday   
        from (select * from view_rptgm155  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}   )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//6 Total Number of services for Gastritis
exports.icdReport6 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm22icd  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//7 Total Number of services for Skin Disease
exports.icdReport7 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm156  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//8 Total Number of services for Dysentery
exports.icdReport8 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm7icd  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//9 Total Number of services for Other GI Disease
exports.icdReport9 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm154 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//10 Total Number of services for UTI
exports.icdReport10 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm19icd where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//11 Total Number of services for STI
exports.icdReport11 = async (a) => {
    try {
        ...
        from (  select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm20icd where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//12 Total Number of services for Anaemia
exports.icdReport12 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm14icd  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//13 Total Number of services for Dental Caries
exports.icdReport13 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm164  where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//14 Total Number of services for DEF
exports.icdReport14 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from (  select * from view_rptgm121 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//15 Total Number of services for Ear Diseases
exports.icdReport15 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  (select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm151 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp}  )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//16 Total Number of services for Eye Diseases
exports.icdReport16 = async (a) => {
    try {
        ...
        from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
        from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
        from ( select * from view_rptgm31icd where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//17 Total Number of services for Heart Disease
exports.icdReport17 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from (  select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm152 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//18 Total Number of services for General Weakness
exports.icdReport18 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from (select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from (  select * from view_rptgm157 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//19 Total Number of services for Ache and Pain
exports.icdReport19 = async (a) => {
    try {
        ...
        sql = ` select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  ( select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm158 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//20 Total Number of services for Pneumonia
exports.icdReport20 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from (select * from view_rptgm159 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//21 Total Number of services for Asthma
exports.icdReport21 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm73 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//22 Total Number of services for Referal for Hospitalization
exports.icdReport22 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm160 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
//23 Total Number of services for Nutrition Support
exports.icdReport23 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm161 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
// 24 Total Number of services for Seasonal Flu
exports.icdReport24 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from ( select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday  
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
             from ( select * from view_rptgm162 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
...
// 25 Total Number of services for Injuries 
exports.icdReport25 = async (a) => {
    try {
        ...
        sql = `select (CASE  WHEN sum(a1) is null THEN 0 ELSE sum(a1) END) maleCount,  (CASE  WHEN sum(a2) is null THEN 0 ELSE sum(a2) END) FemaleCount ,(CASE  WHEN sum(a1+a2) is null THEN 0 ELSE sum(a1+a2) END) allTotal   from ( select (CASE  WHEN regsex=1 THEN 1 ELSE 0  END) AS a1, (CASE  WHEN  regsex=2 THEN 1 ELSE 0  END) AS a2  from (  select tbl1.regid,tbl1.providedDate,tbl1.visitType,tbl1.org,tbl1.donor,tbl1.project,tbl1.tspId,tbl1.providedPlace,tbl1.regSex,tbl1.ageinday 
            from  (  select tbl.regid,tbl.providedDate,tbl.visittype,tbl.org,tbl.donor,tbl.project,tbl.tspId,tbl.providedPlace,tbl.regSex, (tbl.providedDate-tbl.regDate) + (tbl.regAge*tbl.regAgeUnit) as ageinday 
            from ( select * from view_rptgm163 where ( provideddate between To_Date('${parameter.sDate}','YYYY-MM-DD') and To_Date('${parameter.eDate}','YYYY-MM-DD')) ${org} ${proj} ${cln} ${tsp} )  tbl  )  tbl1 ) tbl2 ) tbl3`
