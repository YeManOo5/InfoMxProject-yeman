    ...
    useEffect(async () => {
        ...
        if (sessionStorage.getItem('editDeliPatient') === 'true') {
            ...
            if (service && lab) {
                ...
                deliForm.DELIBWT1 = serviceData[0].DELIBWT1 === 999.9 ? '' : serviceData[0].DELIBWT1
                ...
                deliForm.DELIBWT2 = serviceData[0].DELIBWT2 === 999.9 ? '' : serviceData[0].DELIBWT2
                ...
                deliForm.DELIBWT3 = serviceData[0].DELIBWT3 === 999.9 ? '' : serviceData[0].DELIBWT3
                deliForm.DELIUPDATE = moment(new Date()).format('YYYY-MM-DD hh:mm:ss')
                ...
                let bb2Open = (serviceData[0].DELIBSEX2 !== 999 || serviceData[0].DELIBWT2 !== 999 || serviceData[0].DELIBBF2) ? setBaby2(true) : setBaby2(false)
                let bb3Open = (serviceData[0].DELIBSEX3 !== 999 || serviceData[0].DELIBWT3 !== 999 || serviceData[0].DELIBBF3) ? setBaby3(true) : setBaby3(false)
