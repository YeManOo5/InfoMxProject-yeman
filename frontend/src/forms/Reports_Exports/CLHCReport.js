...
import * as icdRp from '../../modals/clhcreport'
...
export default function CLHCReport() {
  ...
  /////Report Data/////////////
  const indicator = [
    'Total Number of patient who received Hypertension treatment',
    'Total Number of patient who received DM treatment',
    'Total Number of patient who received Malaria treatment',
    'Total Number of patient who received Diarrhoea treatment',
    'Total Number of patient who received Other Respiratory Disease treatment',
    'Total Number of patient who received Gastritis treatment',
    'Total Number of patient who received Skin Disease treatment',
    'Total Number of patient who received Dysentery treatment',
    'Total Number of patient who received Other GI Disease treatment',
    'Total Number of patient who received UTI treatment',
    'Total Number of patient who received STI treatment',
    'Total Number of patient who received Anaemia treatment',
    'Total Number of patient who received Dental Caries treatment',
    'Total Number of patient who received DHF treatment',
    'Total Number of patient who received Ear Diseases treatment',
    'Total Number of patient who received Eye Diseases treatment',
    'Total Number of patient who received Heart Disease treatment',
    'Total Number of patient who received General Weakness treatment',
    'Total Number of patient who received Ache and Pain treatment',
    'Total Number of patient who received Pneumonia treatment',
    'Total Number of patient who received Asthma treatment',
    'Total Number of patient who received Referal for Hospitalization treatment',
    'Total Number of patient who received Nutrition Support treatment',
    'Total Number of patient who received Seasonal Flu treatment',
    'Total Number of patient who received Injuries treatment'
  ]
  ...
  const reportBtn = async () => {
    ...
    setLoading(true)
    var icd = await icdRp.clhcReport({ parameter, select, type: 0 });
    var icdList = []
  ...
  const exportBtn = () => {
    ...
    XLSX.utils.book_append_sheet(wbb, wss, 'CaseLoadHeadCount_Report');
    XLSX.writeFile(wbb, "CaseLoadHeadCount_Report" + `_${moment(new Date()).format('DD-MM-YYYY')}` + '.xlsx');
  }
  ...
  return (
    <>
      ...
      <Typography variant="h5" align="center" style={{ color: '#53344d', background: '#fcf0f2', fontWeight: 'bold', padding: '1%' }}>
        Case Load Head Count Report </Typography>
      <Grid container
        direction="row"
        ...
        <Table id="icdtable" size="small" className={classes.table}>
          <TableBody>
            <TableRow>
              ...
              <TableCell align="center" className={classes.title1}>MaleCount</TableCell>
              <TableCell align="center" className={classes.title1}>FemaleCount</TableCell>
              <TableCell align="center" className={classes.title1}>AllTotal</TableCell>
            </TableRow>
          </TableBody>
          {icdData.length ?
            <TableBody>
