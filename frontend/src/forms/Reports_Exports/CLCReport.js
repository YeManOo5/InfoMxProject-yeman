...
import * as icdRp from '../../modals/clcreport'
...
export default function CLCReport() {
  ...
  const [tspSelect, setTspSelect] = useState([])
   ...
   /////Report Data/////////////
   const indicator = [
    'Total Number of services for Hypertension',
    'Total Number of services for DM',
    'Total Number of services for Malaria',
    'Total Number of services for Diarrhoea',
    'Total Number of services for Other Respiratory Disease',
    'Total Number of services for Gastritis',
    'Total Number of services for Skin Disease',
    'Total Number of services for Dysentery',
    'Total Number of services for Other GI Disease',
    'Total Number of services for UTI',
    'Total Number of services for STI',
    'Total Number of services for Anaemia',
    'Total Number of services for Dental Caries',
    'Total Number of services for DEF',
    'Total Number of services for Ear Diseases',
    'Total Number of services for Eye Diseases',
    'Total Number of services for Heart Disease',
    'Total Number of services for General Weakness',
    'Total Number of services for Ache and Pain',
    'Total Number of services for Pneumonia',
    'Total Number of services for Asthma',
    'Total Number of services for Referal for Hospitalization',
    'Total Number of services for Nutrition Support',
    'Total Number of services for Seasonal Flu',
    'Total Number of services for Injuries '
  ]
  ...
  const reportBtn = async () => {
    ...
    setLoading(true)
    var icd = await icdRp.clcReport({ parameter, select, type:0});
    var icdList = []
  ...
  const exportBtn = () => {
    ...
    XLSX.utils.book_append_sheet(wbb, wss, 'CaseLoadComulative_Report');
    XLSX.writeFile(wbb, "CaseLoadComulative_Report" + `_${moment(new Date()).format('DD-MM-YYYY')}` + '.xlsx');
  }
  ...
  return (
    ...
    <Modals open={loading} />
      ...
      Case Load Comulative Count Report </Typography>
      <Grid container
        direction="row"
