...
export default function CFRMEditForm() {
  ...
  const PERSONCAT1 = [
    ...
    { value: '2', name: 'စီမံကိန်းဝန်ထမ်း' },
    { value: '3', name: 'စီမံကိန်းခေါင်းဆောင်' },
      ...
      <Grid container >
        <Grid item xs={12} sm={12} md={12} >
          <Typography variant="subtitle1" align="center" style={{ color: '#53344d', background: '#fcf0f2', fontWeight: 'bold' }} display="inline"   >
            စီမံကိန်း၀န်ဆောင်မှုရယူသူများအတွက်</Typography> </Grid >
      ...
      <Card
        ...
        <Grid
          ...
          <Grid item spacing={2} xs={12} sm={12} md={12} style={{ alignContent: 'center', alignItems: 'center', marginBottom: '10px', marginTop: '15px' }}>
            <Typography align='center' variant="subtitle1" color="#482642" style={{ background: '#ddd3d5', fontWeight: 'bold', color: "#d91d4c" }} >စီမံကိန်း၏လုပ်ဆောင်ချက်များအပေါ် စိတ်ကျေနပ်မှု</Typography></Grid>
              ...
              <ThemeProvider theme={radioTheme}>
                <FormControl variant="filled" className={classes.secondFormControl} style={{ width: '90%', backgroundColor: 'white' }}>
                  ...
                  <Select
                    ...
                    <MenuItem classes={{ selected: classes.selected }} value={'1'}>စီမံကိန်းဝန်ထမ်းများမှ တဆင့်</MenuItem>
      ...
      <Card
        ...
        <Grid container style={{ marginTop: '20px', marginBottom: '12px' }} >
          <Grid item spacing={2} xs={12} sm={12} md={12} style={{ alignContent: 'center', alignItems: 'center', marginBottom: '15px' }}>
            <Typography align='center' variant="subtitle1" color="#482642" style={{ background: '#ddd3d5', fontWeight: 'bold', color: "#d91d4c" }}  >စာအိတ်ဖွင့်သူ တာဝန်ခံသူ/ သတ်မှတ်ထားသော တာဝန်ရှိစီမံကိန်းဝန်ထမ်းမှ ဖြည့်သွင်းရန်</Typography>
          </Grid>
              ...
              <ThemeProvider theme={radioTheme}>
                <FormControl variant="filled" className={classes.secondFormControl} style={{ width: '90%', backgroundColor: 'white' }}>
                  ...
                  <Select
                    ...
                    <MenuItem classes={{ selected: classes.selected }} value={'2'}>စီမံကိန်းဝန်ထမ်း</MenuItem>
                    <MenuItem classes={{ selected: classes.selected }} value={'3'}>စီမံကိန်းခေါင်းဆောင်</MenuItem>
