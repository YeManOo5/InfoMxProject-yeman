...
//////////////////API//////////////////
import * as fp from '../../modals/fpinfo'
import * as lab from '../../modals/labinfo'
import { deleteIMAM } from '../../modals/imaminfo';
...
export default function CustomOTPDeleteDialog(props) {
    ...
    const deleteHandle = async() => {
      ...
      ORGID : sessionStorage.getItem('org'),
        ...
        const rhres = await deleteIMAM(rhData);
